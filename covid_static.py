...
data = covid_pop[covid_pop['date'] == date]
...
fig.update_layout(
    ...
    title_text='Cases per 1M people as of '+date+'<br>By US counties',
    annotations=[
...
fig.show()
plotly.offline.plot(fig, filename='covid_map_static/index.html')
